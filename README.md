...
Само общение реализуется путём отправления сообщений между ними, сами сообщения в открытой среде никак не защищаются, что может привести к утечке конфиденциальных данных, полной модификацией злоумышленником этих конфиденциальных данных и отправления их на сервер, и (или) полного перехвата данных.
