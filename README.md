...
- **Корневой сертификат (CA)** - это сертификат, который находится в основании дерева сертификатов, он самозаверяется

- **Серверный сертификат** - это сертификат, который подписывается корневым или промежуточным сертификатом и устанавливается на сервере.

- **Помежуточный сертификат** - это сертификат, который подписывается корневым сертификатом и обеспечивает звено доверия между различными сертификатами, таким образом, у производитель корневого сертификата может подписать несколько промежуточных сертификатов, тем самым, обеспечивая их возможностью быть доверенными промежуточными центрами сертификации и реализует возможность подписывать другие сертификаты 
